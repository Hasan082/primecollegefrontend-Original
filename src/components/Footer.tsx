        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li>
                <Link
                  to="/qualifications/othm-level-6-diploma-in-business-management"
                  className="hover:text-primary-foreground"
                >
                  Business Management
                </Link>
              ...
              <li>
                <Link
                  to="/qualifications/othm-level-7-diploma-in-strategic-management-and-leadership"
                  className="hover:text-primary-foreground"
                >
              ...
              <li>
                <Link
                  to="/qualifications/qualifi-level-3-diploma-in-health-and-social-care"
                  className="hover:text-primary-foreground"
                >
                  Health & Social Care
                </Link>
              ...
              <li>
                <Link
                  to="/qualifications/othm-level-7-diploma-in-healthcare-management"
                  className="hover:text-primary-foreground"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li>
                Aegon House (Left side), Ground Floor Suite, 13 Lanark Square,
                London E14 9QD
              </li>
              <li>
                <a
